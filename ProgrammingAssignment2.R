...
# Instructions
# 
# second programming assignment will require you to write an R function 
...
# repository. For example, if you made a total of 10 commits to this repository, 
# the link should say “10 commits”.
